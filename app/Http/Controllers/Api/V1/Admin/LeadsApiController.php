...
class LeadsApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new LeadResource(Lead::with(['salutation', 'interested', 'lead_status', 'lead_source', 'lead_category', 'permissions'])->get());
    }
    ...
    public function show(Lead $lead)
    {
        ...
        return new LeadResource($lead->load(['salutation', 'interested', 'lead_status', 'lead_source', 'lead_category', 'permissions']));
    }
