...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dailyAttendance.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("hr.admin.daily-attendances.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clock_in') ? 'is-invalid' : '' }}" type="text" name="clock_in" id="clock_in" value="{{ old('clock_in', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clock_out') ? 'is-invalid' : '' }}" type="text" name="clock_out" id="clock_out" value="{{ old('clock_out', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('absent') ? 'is-invalid' : '' }}" type="number" name="absent" id="absent" value="{{ old('absent', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vacation') ? 'is-invalid' : '' }}" type="number" name="vacation" id="vacation" value="{{ old('vacation', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday') ? 'is-invalid' : '' }}" type="number" name="holiday" id="holiday" value="{{ old('holiday', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('created_day') ? 'is-invalid' : '' }}" type="text" name="created_day" id="created_day" value="{{ old('created_day') }}">
