...
@can('employee_award_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('hr.admin.employee-awards.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-EmployeeAward">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <tr data-entry-id="{{ $employeeAward->id }}">
                            ...
                            <td>
                                ...
                                @can('employee_award_delete')
                                    <form action="{{ route('hr.admin.employee-awards.destroy', $employeeAward->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('employee_award_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('hr.admin.employee-awards.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-EmployeeAward:not(.ajaxTable)').DataTable({ buttons: dtButtons })
