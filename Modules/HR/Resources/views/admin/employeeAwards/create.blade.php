...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employeeAward.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("hr.admin.employee-awards.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gift_item') ? 'is-invalid' : '' }}" type="text" name="gift_item" id="gift_item" value="{{ old('gift_item', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('award_amount') ? 'is-invalid' : '' }}" type="number" name="award_amount" id="award_amount" value="{{ old('award_amount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('given_date') ? 'is-invalid' : '' }}" type="text" name="given_date" id="given_date" value="{{ old('given_date') }}">
