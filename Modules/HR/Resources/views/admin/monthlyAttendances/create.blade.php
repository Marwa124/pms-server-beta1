    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.monthly-attendances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_hours') ? 'is-invalid' : '' }}" type="number" name="total_hours" id="total_hours" value="{{ old('total_hours', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_absence') ? 'is-invalid' : '' }}" type="number" name="total_absence" id="total_absence" value="{{ old('total_absence', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_vacation') ? 'is-invalid' : '' }}" type="number" name="total_vacation" id="total_vacation" value="{{ old('total_vacation', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holidays') ? 'is-invalid' : '' }}" type="number" name="holidays" id="holidays" value="{{ old('holidays', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('created_month') ? 'is-invalid' : '' }}" type="text" name="created_month" id="created_month" value="{{ old('created_month') }}">
