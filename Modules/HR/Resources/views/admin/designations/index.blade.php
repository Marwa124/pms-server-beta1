...
@can('designation_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('hr.admin.designations.create') }}">
                        ...
                        <tr data-entry-id="{{ $designation->id }}">
                            ...
                            <td>
                                ...
                                @can('designation_delete')
                                    <form action="{{ route('hr.admin.designations.destroy', $designation->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('designation_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('hr.admin.designations.massDestroy') }}",
