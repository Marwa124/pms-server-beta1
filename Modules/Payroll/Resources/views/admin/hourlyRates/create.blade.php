...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.hourlyRate.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("payroll.admin.hourly-rates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hourly_grade') ? 'is-invalid' : '' }}" type="text" name="hourly_grade" id="hourly_grade" value="{{ old('hourly_grade', '') }}" required>
