    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.quotations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.quotation.fields.title') }}</label>
            ...
            <div class="form-group">
                <label for="user_id">{{ trans('cruds.quotation.fields.user') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.quotation.fields.user_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="client_id">{{ trans('cruds.quotation.fields.client') }}</label>
            ...
            <div class="form-group">
                <label for="mobile">{{ trans('cruds.quotation.fields.mobile') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.quotation.fields.mobile_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="amount">{{ trans('cruds.quotation.fields.amount') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.quotation.fields.amount_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="notes">{{ trans('cruds.quotation.fields.notes') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.quotation.fields.notes_helper') }}</span>
            </div>
            <div class="form-group">
                <label>{{ trans('cruds.quotation.fields.status') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.quotation.fields.status_helper') }}</span>
            </div>
            <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/quotations/ckmedia', true);
                ...
                data.append('crud_id', {{ $quotation->id ?? 0 }});
                xhr.send(data);
              });
            })
        }
