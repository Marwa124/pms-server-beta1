...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.returnStock.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.return-stocks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReturnStock::UPDATE_STOCK_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('update_stock') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="update_stock_{{ $key }}" name="update_stock" value="{{ $key }}" {{ old('update_stock', 'yes') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReturnStock::EMAILED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('emailed') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="emailed_{{ $key }}" name="emailed" value="{{ $key }}" {{ old('emailed', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('return_stock_date') ? 'is-invalid' : '' }}" type="text" name="return_stock_date" id="return_stock_date" value="{{ old('return_stock_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_percent') ? 'is-invalid' : '' }}" type="number" name="discount_percent" id="discount_percent" value="{{ old('discount_percent', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adjustment') ? 'is-invalid' : '' }}" type="number" name="adjustment" id="adjustment" value="{{ old('adjustment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('show_quantity_as') ? 'is-invalid' : '' }}" type="text" name="show_quantity_as" id="show_quantity_as" value="{{ old('show_quantity_as', '') }}">
