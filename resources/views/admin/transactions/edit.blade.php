    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id">
                    @foreach($projects as $id => $project)
                        <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $transaction->project->id ?? '') == $id ? 'selected' : '' }}>{{ $project }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('account') ? 'is-invalid' : '' }}" name="account_id" id="account_id" required>
                    @foreach($accounts as $id => $account)
                        <option value="{{ $id }}" {{ (old('account_id') ? old('account_id') : $transaction->account->id ?? '') == $id ? 'selected' : '' }}>{{ $account }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('invoice') ? 'is-invalid' : '' }}" name="invoice_id" id="invoice_id" required>
                    @foreach($invoices as $id => $invoice)
                        <option value="{{ $id }}" {{ (old('invoice_id') ? old('invoice_id') : $transaction->invoice->id ?? '') == $id ? 'selected' : '' }}>{{ $invoice }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" name="payment_method_id" id="payment_method_id">
                    @foreach($payment_methods as $id => $payment_method)
                        <option value="{{ $id }}" {{ (old('payment_method_id') ? old('payment_method_id') : $transaction->payment_method->id ?? '') == $id ? 'selected' : '' }}>{{ $payment_method }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paid_by') ? 'is-invalid' : '' }}" type="number" name="paid_by" id="paid_by" value="{{ old('paid_by', $transaction->paid_by) }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Transaction::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $transaction->status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $transaction->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tags') ? 'is-invalid' : '' }}" type="text" name="tags" id="tags" value="{{ old('tags', $transaction->tags) }}">
                @if($errors->has('tags'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tags') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="number" name="tax" id="tax" value="{{ old('tax', $transaction->tax) }}" step="0.01">
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $transaction->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('debit') ? 'is-invalid' : '' }}" type="number" name="debit" id="debit" value="{{ old('debit', $transaction->debit) }}" step="0.01">
                @if($errors->has('debit'))
                    <div class="invalid-feedback">
                        {{ $errors->first('debit') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit') ? 'is-invalid' : '' }}" type="number" name="credit" id="credit" value="{{ old('credit', $transaction->credit) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_balance') ? 'is-invalid' : '' }}" type="number" name="total_balance" id="total_balance" value="{{ old('total_balance', $transaction->total_balance) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('permissions') ? 'is-invalid' : '' }}" name="permissions[]" id="permissions" multiple>
                    @foreach($permissions as $id => $permissions)
                        <option value="{{ $id }}" {{ (in_array($id, old('permissions', [])) || $transaction->permissions->contains($id)) ? 'selected' : '' }}>{{ $permissions }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Transaction::CLIENT_VISIBLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('client_visible') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="client_visible_{{ $key }}" name="client_visible" value="{{ $key }}" {{ old('client_visible', $transaction->client_visible) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('added_by') ? 'is-invalid' : '' }}" type="number" name="added_by" id="added_by" value="{{ old('added_by', $transaction->added_by) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paid') ? 'is-invalid' : '' }}" type="number" name="paid" id="paid" value="{{ old('paid', $transaction->paid) }}" step="1">
                @if($errors->has('paid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('paid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Transaction::BILLABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('billable') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="billable_{{ $key }}" name="billable" value="{{ $key }}" {{ old('billable', $transaction->billable) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deposit') ? 'is-invalid' : '' }}" type="text" name="deposit" id="deposit" value="{{ old('deposit', $transaction->deposit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deposit_2') ? 'is-invalid' : '' }}" type="text" name="deposit_2" id="deposit_2" value="{{ old('deposit_2', $transaction->deposit_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('under_55') ? 'is-invalid' : '' }}" type="text" name="under_55" id="under_55" value="{{ old('under_55', $transaction->under_55) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('expense_category') ? 'is-invalid' : '' }}" name="expense_category_id" id="expense_category_id">
                    @foreach($expense_categories as $id => $expense_category)
                        <option value="{{ $id }}" {{ (old('expense_category_id') ? old('expense_category_id') : $transaction->expense_category->id ?? '') == $id ? 'selected' : '' }}>{{ $expense_category }}</option>
                    @endforeach
                </select>
