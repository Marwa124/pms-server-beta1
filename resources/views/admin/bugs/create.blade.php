...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bugs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('severity') ? 'is-invalid' : '' }}" type="text" name="severity" id="severity" value="{{ old('severity', '') }}">
