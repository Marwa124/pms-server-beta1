    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.invoices.update", [$invoice->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('recur_start_date') ? 'is-invalid' : '' }}" type="text" name="recur_start_date" id="recur_start_date" value="{{ old('recur_start_date', $invoice->recur_start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('recur_end_date') ? 'is-invalid' : '' }}" type="text" name="recur_end_date" id="recur_end_date" value="{{ old('recur_end_date', $invoice->recur_end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id" required>
                    @foreach($clients as $id => $client)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $invoice->client->id ?? '') == $id ? 'selected' : '' }}>{{ $client }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id">
                    @foreach($projects as $id => $project)
                        <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $invoice->project->id ?? '') == $id ? 'selected' : '' }}>{{ $project }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_overdue') ? 'is-invalid' : '' }}" type="number" name="alert_overdue" id="alert_overdue" value="{{ old('alert_overdue', $invoice->alert_overdue) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $invoice->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="number" name="tax" id="tax" value="{{ old('tax', $invoice->tax) }}" step="0.01" required>
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_tax') ? 'is-invalid' : '' }}" type="text" name="total_tax" id="total_tax" value="{{ old('total_tax', $invoice->total_tax) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_percent') ? 'is-invalid' : '' }}" type="number" name="discount_percent" id="discount_percent" value="{{ old('discount_percent', $invoice->discount_percent) }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Invoice::RECURRING_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('recurring') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="recurring_{{ $key }}" name="recurring" value="{{ $key }}" {{ old('recurring', $invoice->recurring) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recurring_frequency') ? 'is-invalid' : '' }}" type="text" name="recurring_frequency" id="recurring_frequency" value="{{ old('recurring_frequency', $invoice->recurring_frequency) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recur_frequency') ? 'is-invalid' : '' }}" type="text" name="recur_frequency" id="recur_frequency" value="{{ old('recur_frequency', $invoice->recur_frequency) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('recur_next_date') ? 'is-invalid' : '' }}" type="text" name="recur_next_date" id="recur_next_date" value="{{ old('recur_next_date', $invoice->recur_next_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currerncy') ? 'is-invalid' : '' }}" type="text" name="currerncy" id="currerncy" value="{{ old('currerncy', $invoice->currerncy) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('archived') ? 'is-invalid' : '' }}" type="number" name="archived" id="archived" value="{{ old('archived', $invoice->archived) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_sent') ? 'is-invalid' : '' }}" type="text" name="date_sent" id="date_sent" value="{{ old('date_sent', $invoice->date_sent) }}">
