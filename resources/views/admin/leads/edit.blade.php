    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leads.update", [$lead->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_name') ? 'is-invalid' : '' }}" type="text" name="contact_name" id="contact_name" value="{{ old('contact_name', $lead->contact_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('salutation') ? 'is-invalid' : '' }}" name="salutation_id" id="salutation_id">
                    @foreach($salutations as $id => $salutation)
                        <option value="{{ $id }}" {{ (old('salutation_id') ? old('salutation_id') : $lead->salutation->id ?? '') == $id ? 'selected' : '' }}>{{ $salutation }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('interested') ? 'is-invalid' : '' }}" name="interested_id" id="interested_id">
                    @foreach($interesteds as $id => $interested)
                        <option value="{{ $id }}" {{ (old('interested_id') ? old('interested_id') : $lead->interested->id ?? '') == $id ? 'selected' : '' }}>{{ $interested }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization') ? 'is-invalid' : '' }}" type="text" name="organization" id="organization" value="{{ old('organization', $lead->organization) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lead_status') ? 'is-invalid' : '' }}" name="lead_status_id" id="lead_status_id">
                    @foreach($lead_statuses as $id => $lead_status)
                        <option value="{{ $id }}" {{ (old('lead_status_id') ? old('lead_status_id') : $lead->lead_status->id ?? '') == $id ? 'selected' : '' }}>{{ $lead_status }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lead_source') ? 'is-invalid' : '' }}" name="lead_source_id" id="lead_source_id">
                    @foreach($lead_sources as $id => $lead_source)
                        <option value="{{ $id }}" {{ (old('lead_source_id') ? old('lead_source_id') : $lead->lead_source->id ?? '') == $id ? 'selected' : '' }}>{{ $lead_source }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lead_category') ? 'is-invalid' : '' }}" name="lead_category_id" id="lead_category_id">
                    @foreach($lead_categories as $id => $lead_category)
                        <option value="{{ $id }}" {{ (old('lead_category_id') ? old('lead_category_id') : $lead->lead_category->id ?? '') == $id ? 'selected' : '' }}>{{ $lead_category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imported_from_email') ? 'is-invalid' : '' }}" type="number" name="imported_from_email" id="imported_from_email" value="{{ old('imported_from_email', $lead->imported_from_email) }}" step="1">
            ...
            <div class="form-group">
                <label for="email_integration_uid">{{ trans('cruds.lead.fields.email_integration_uid') }}</label>
                <input class="form-control {{ $errors->has('email_integration_uid') ? 'is-invalid' : '' }}" type="text" name="email_integration_uid" id="email_integration_uid" value="{{ old('email_integration_uid', $lead->email_integration_uid) }}">
                @if($errors->has('email_integration_uid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email_integration_uid') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.lead.fields.email_integration_uid_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $lead->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $lead->state) }}">
                @if($errors->has('state'))
                    <div class="invalid-feedback">
                        {{ $errors->first('state') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $lead->city) }}">
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $lead->title) }}">
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $lead->facebook) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $lead->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('skype') ? 'is-invalid' : '' }}" type="text" name="skype" id="skype" value="{{ old('skype', $lead->skype) }}">
                @if($errors->has('skype'))
                    <div class="invalid-feedback">
                        {{ $errors->first('skype') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $lead->twitter) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('permissions') ? 'is-invalid' : '' }}" name="permissions[]" id="permissions" multiple>
                    @foreach($permissions as $id => $permission)
                        <option value="{{ $id }}" {{ (in_array($id, old('permissions', [])) || $lead->permissions->contains($id)) ? 'selected' : '' }}>{{ $permission }}</option>
                    @endforeach
                </select>
