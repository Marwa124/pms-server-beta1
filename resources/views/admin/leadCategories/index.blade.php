            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-LeadCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.leadCategory.fields.type') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                        ...
                        <tr data-entry-id="{{ $leadCategory->id }}">
                            ...
                            <td>
                                @can('lead_category_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.lead-categories.show', $leadCategory->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('lead_category_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.lead-categories.edit', $leadCategory->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
