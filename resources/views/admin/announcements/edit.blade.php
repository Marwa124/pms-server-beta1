    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.update", [$announcement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $announcement->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('view_status') ? 'is-invalid' : '' }}" type="number" name="view_status" id="view_status" value="{{ old('view_status', $announcement->view_status) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $announcement->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $announcement->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('all_client') ? 'is-invalid' : '' }}" type="text" name="all_client" id="all_client" value="{{ old('all_client', $announcement->all_client) }}">
