...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.outgoingEmail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.outgoing-emails.update", [$outgoingEmail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="send_to">{{ trans('cruds.outgoingEmail.fields.send_to') }}</label>
                <input class="form-control {{ $errors->has('send_to') ? 'is-invalid' : '' }}" type="text" name="send_to" id="send_to" value="{{ old('send_to', $outgoingEmail->send_to) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('send_from') ? 'is-invalid' : '' }}" type="text" name="send_from" id="send_from" value="{{ old('send_from', $outgoingEmail->send_from) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('subject') ? 'is-invalid' : '' }}" name="subject" id="subject">{!! old('subject', $outgoingEmail->subject) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{!! old('message', $outgoingEmail->message) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivered') ? 'is-invalid' : '' }}" type="number" name="delivered" id="delivered" value="{{ old('delivered', $outgoingEmail->delivered) }}" step="1">
